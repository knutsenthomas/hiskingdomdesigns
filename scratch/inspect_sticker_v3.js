...
async function main() {
  console.log('Querying product from Wix Catalog V3 REST API...');
  const url = 'https://www.wixapis.com/stores/v3/products/query';
  const response = await fetch(url, {
    ...
    body: JSON.stringify({
      query: {
        filter: {
          id: 'bcf7626f-9509-7151-8a1e-d7ce4c3c7cef'
        }
      }
    })
  });
