...
async function main() {
  ...
  const structures = [
    {
      label: "variantId + options.options + customTextFields.freeTextSettings.key + sibling value (INSIDE)",
      lineItem: {
        catalogReference: {
          appId,
    ...
    {
      label: "variantId + options.options + customTextFields.freeTextSettings.key + sibling text (INSIDE)",
      lineItem: {
        catalogReference: {
          appId,
          catalogItemId: itemId,
    ...
    {
      label: "variantId + options.options + customTextFields.title + value (INSIDE)",
      lineItem: {
        catalogReference: {
          appId,
          catalogItemId: itemId,
    ...
    {
      label: "variantId + options.options + customTextFields.key + value (INSIDE)",
      lineItem: {
        catalogReference: {
          appId,
          catalogItemId: itemId,
    ...
    {
      label: "variantId + options.options + customTextFields.freeTextSettings.key + sibling value (OUTSIDE)",
      lineItem: {
        catalogReference: {
          appId,
          catalogItemId: itemId,
    ...
    {
      label: "variantId + options.options + customTextFields.title + value (OUTSIDE)",
      lineItem: {
        catalogReference: {
          appId,
          catalogItemId: itemId,
  ...
  console.log('All variant free text tests finished.');
}
